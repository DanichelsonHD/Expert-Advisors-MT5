...
#include "variables.h"
#pragma pack(pop)
#pragma warning( disable: 4244 4800 4311 4996 4267)

#define DLLFUNC extern "C" __declspec(dllexport)
#define function DLLFUNC int
...
#define III reinterpret_cast<void*>
#include "functions.h"
...
{ return of0(CCC(p0), CCC(p1), CCC(p2), CCC(p3), CCC(p4), CCC(p5), CCC(p6), CCC(p7), CCC(p8), CCC(p9), CCC(p10), CCC(p11), CCC(p12), CCC(p13), CCC(p14), CCC(p15), CCC(p16), CCC(p17), CCC(p18), CCC(p19),
	CCC(p20), CCC(p21), CCC(p22), CCC(p23), CCC(p24), CCC(p25), CCC(p26), CCC(p27), CCC(p28), CCC(p29), CCC(p30), CCC(p31), CCC(p32), CCC(p33), CCC(p34), CCC(p35), CCC(p36), CCC(p37), CCC(p38), CCC(p39));}
inline intptr_t of(intptr_t p0=0,intptr_t p1=0,intptr_t p2=0,intptr_t p3=0,intptr_t p4=0,intptr_t p5=0,intptr_t p6=0,intptr_t p7=0,intptr_t p8=0,intptr_t p9=0,intptr_t p10=0,intptr_t p11=0,intptr_t p12=0,intptr_t p13=0,intptr_t p14=0,intptr_t p15=0,intptr_t p16=0,intptr_t p17=0,intptr_t p18=0,intptr_t p19=0,
	intptr_t p20=0,intptr_t p21=0,intptr_t p22=0,intptr_t p23=0,intptr_t p24=0,intptr_t p25=0,intptr_t p26=0,intptr_t p27=0,intptr_t p28=0,intptr_t p29=0,intptr_t p30=0,intptr_t p31=0,intptr_t p32=0,intptr_t p33=0,intptr_t p34=0,intptr_t p35=0,intptr_t p36=0,intptr_t p37=0,intptr_t p38=0,intptr_t p39=0)
{ return (intptr_t) of0(III(p0),III(p1),III(p2),III(p3),III(p4),III(p5),III(p6),III(p7),III(p8),III(p9),III(p10),III(p11),III(p12),III(p13),III(p14),III(p15),III(p16),III(p17),III(p18),III(p19,
	p20),III(p21),III(p22),III(p23),III(p24),III(p25),III(p26),III(p27),III(p28),III(p29),III(p30),III(p31),III(p32),III(p33),III(p34),III(p35),III(p36),III(p37),III(p38),III(p39)); }

inline var optimize(const char* Name,var Default,var Start,var End,var Step,var Bias=0.)
{ return optimize1(Name,Default,Start,End,Step,Bias); }
inline var optimize(var Default,var Start,var End,var Step,var Bias=0.)
{ return optimize1(NULL,Default,Start,End,Step,Bias); }
...
inline vars conv(float* fData,int Length=0,int Stride=0) { return conv0(fData,Length,Stride); }
...
inline size_t file_appendCSV0(const char* name,const char* content) { return file_appendCSV(name,content,0,1); }
inline var second(DATE Time) { return second1(Time); }
inline var second() { return second0(); }
inline var nthDay(var Date,int Dow,int N) { return nthDay0(Date,Dow,N); }
inline var nthDay(int Year,int Month,int Dow,int N) { return nthDay1(Year,Month,Dow,N); }
...
inline char* strxc(const char* In,char Orig,char Repl)
{ return strxc0(In,Orig,Repl); } 
inline int strxc(char *Out,const char* In,char Orig,char Repl)
{ return strxc1(Out,In,Orig,Repl); } 

inline var LowPass(vars Data,int Cutoff) { return LowPass0(Data,Cutoff); }
inline var LowPass(var* Buffer,var Val,int Cutoff) { return LowPass1(Buffer,Val,Cutoff); }
...
inline var TrueRange(int Offset = 0) { return TrueRange1(Offset); }
