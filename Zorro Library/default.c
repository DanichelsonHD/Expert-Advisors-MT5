...
var optimize(string Name,var val,var start,var end,var step) { return optimize(Name,val,start,end,step,0); }
var optimize(string Name,var val,var start,var end) { return optimize(Name,val,start,end,0,0); }
...
var objective()
{
	if(NumWinTotal < 2 || NumWinTotal+NumLossTotal < MinTrades) 
		return 0.;	// needs at least 10 trades
