...
C char* F0(strxc)(const char* str,char orig,char repl);
...
// dataset
C uint F(dataDownload)(const char* Code,int Mode,int Period);
C uint F0(dataParse)(int Handle,const char* Format,const char* FileName);
C uint F(dataSave)(int Handle,const char* FileName,int Start,int Num,...);
C uint F(dataSaveCSV)(int Handle,const char* Format,const char* Name,int Start,int Num,...);
C uint F(dataLoad)(int Handle,const char* FileName,int Fields);
C float* F(dataNew)(int Handle,uint Records,uint Fields);
C int F(dataSort)(int Handle);
C uint F(dataMerge)(int Handle1,int Handle2);
C uint F(dataAppend)(int Handle1,int Handle2,int Start,int Num,...);
C uint F(dataFind)(int Handle,var Date);
...
// optimize
C var F0(optimize)(var Default,var Start,var End,var Step,var Bias);
...
C uint F1(dataParse)(int Handle,const char* Format,const char* FileName,int Start,int Num);
C uint F2(dataParse)(int Handle,const char* Format,const char* FileName,const char* Filter);
...
C uint F(dataCompress)(int Handle,const char* FileName,int Fields,var Resolution);
...
C uint F(dataClip)(int H,uint Rows);
...
C var* F1(conv)(float* fData,int Length);
...
// 2.40
C uint F(dataSize)(int Handle,int *Rows,int *Cols);
C uint F(dataParseString)(int Handle,const char* Format,char* Content);
C DATE F(mtu)(int UnixTime);
C void F(matSaveCSV)(mat M,const char* Name);
C uint F(dataRearrange)(int H1,int H2,int RowX,int RowY,int Mode);
C uint F(dataCol)(int Handle,var* Data,int Col);
C void F(dataChart)(int Handle,const char* name,int Type,var* Scale);
...
C uint F(dataDelete)(int Handle,int Row1,int Row2);
...
C uint F(dataRow)(int Handle,void* Record);
...
//2.62
C int F(NumAbove)(vars Data,int Period,var vThreshold);
C var F(VolatilityP)(int Period);

//2.64
C uint F(dataCompressSelf)(int Handle,var MinTime);
C mat F(matSort)(mat M,int col);

//2.66
C int F(contractChain)(const char* Name,int* Par);

//2.70
C var F(HighPass3)(var* Data,int Period);
C var F(MAE)(var* Data,int Period);
C var F1(optimize)(const char* Name,var Default,var Start,var End,var Step,var Bias);
C var* F0(conv)(float* fData,int Length,int Stride);
C var F1(TrueRange)(int Offset);
C int F(strselect)(const char** List,int N);
C int F1(strxc)(char* out,const char* str,char orig,char repl);
C var F0(nthDay)(var Date,int Dow,int N);
C var F1(nthDay)(int Year,int Month,int Dow,int N);
C var F(LRSI)(vars Data,var Alpha);

//2.73
C int F(file_appendCSV)(const char* FileName,const char* Line,int Field1,int Field2);
C int F(file_sortCSV)(const char* FileName,int Num,int Mode);
C var F(strvarCSV)(const char* str,const char* Name,int Field,var Val);
C string F(strfield)(string str,const char* Name,int Field);
C string F(strtextCSV)(const char* str,const char* name,int field,const char* text);
C int F(phantom)(int Dir,int FastPeriod,int SlowPeriod);
C var F(optimalf)(const char* AssetName,const char* AlgoName,int Dir);
C void* F(event)(int Event,void* Address);
