...
#define BidPrice	(g->asset->vPrice-g->asset->vSpread)
#define AskSize	g->asset->vAskVol
#define BidSize	g->asset->vBidVol
...
#define Algo		(g->sAlgo)
#define RootName	g->sScript
#define History		g->sHistory
#define WebFolder	g->sWebFolder
#define LogFolder	g->sLogFolder
...
#define ObjectiveLong	g->statLong->vObjective
#define ObjectiveShort	g->statShort->vObjective
#define TrainPF			g->statShort->vObjective
#define ResultLong		(g->statLong->Result)
#define ResultShort		(g->statShort->Result)
#define PerfShort		(g->statShort->vPerformance)
#define PerfLong		(g->statLong->vPerformance)
#define SkippedLong		(g->statLong->vSkippedMargin)
#define SkippedShort	(g->statShort->vSkippedMargin)
#define ThisPerformance	(g->w)
//#define DailyShort		(g->statShort->pCurve)
//#define DailyTotal		(g->pCurve)

#define DrawDownMax		g->w.vDrawDown
#define DrawDownPercent	((var)g->w.fDrawDownPercent)
#define InterestCost	g->w.vInterestSum
#define MAEDepth		g->w.vEquityDown
#define MarginMax		g->w.vMarginMax
#define RiskMax			g->w.vRiskMax
