#property copyright "Structural Trendline Breakout EA v1.06"
#property link      ""
...
bool CheckHardFilters(const bool isBuy,
                      ...
                      const double atrAvg)
{
    // HARD FILTER 1: Structural breakout close
    if (isBuy)
    {
    ...
    // HARD FILTER 2: Valid compression environment
...
bool CheckBreakout(const double atrAvg)
{
    ...
    if (g_lastLossBar >= 0)
    {
        ...
        int currentShift  = 1;
        int barsSinceLoss = currentShift - lastLossShift;
