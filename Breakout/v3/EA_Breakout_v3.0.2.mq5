#property copyright "EA_Breakout_v3.0.2"
#property link      ""
...
input int InpMinSwingsForBreakout = 3; // Minimum structural swings required
...
int CheckBreakout()
{
    ...
    if (g_SwingHighCount >= InpMinSwingsForBreakout)
    {
        ...
        if (g_Rates[1].close > trendVal + InpBreakoutBufferATR * g_ATR[1])
        {
