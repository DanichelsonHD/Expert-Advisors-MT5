...
// ── Trade settings ────────────────────────────────────────────
// Magic numbers: documentation only. Zorro owns all trades
// opened by this script; no runtime filtering is performed.
...
// ── Globals ───────────────────────────────────────────────────
// g_initialBalance: captured at INITRUN; informational only.
// g_currentScaledLot removed (#10): lot recomputed each call.
