...
input bool   InpUseLossCooldown        = true;  // Enable loss streak cooldown
input int    InpMaxConsecutiveLosses   = 3;     // Consecutive losses before cooldown
input double InpCooldownHours          = 6.0;   // Cooldown duration (hours)
